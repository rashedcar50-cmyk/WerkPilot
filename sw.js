const CACHE='baymeister-v1.12.75';
const PRECACHE=[
  './','./index.html','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png',
  './css/app.css?v=1.12.75','./i18n.js?v=1.12.75','./supabase-config.js',
  './js/config.js?v=1.12.75','./js/engine.js?v=1.12.75','./js/core.js?v=1.12.75','./js/ocr.js?v=1.12.75','./js/cloud.js?v=1.12.75',
  './js/lookup.js?v=1.12.75','./js/quality.js?v=1.12.75','./js/scan.js?v=1.12.75','./js/app.js?v=1.12.75'
];
