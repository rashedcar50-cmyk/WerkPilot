const CACHE='baymeister-v1.12.79';
const PRECACHE=[
  './','./index.html','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png',
  './css/app.css?v=1.12.79','./i18n.js?v=1.12.79','./supabase-config.js',
  './js/config.js?v=1.12.79','./js/engine.js?v=1.12.79','./js/core.js?v=1.12.79','./js/ocr.js?v=1.12.79','./js/cloud.js?v=1.12.79',
  './js/lookup.js?v=1.12.79','./js/quality.js?v=1.12.79','./js/scan.js?v=1.12.79','./js/invoice-print.js?v=1.12.79','./js/print.js?v=1.12.79','./js/camera.js?v=1.12.79','./js/customers.js?v=1.12.79','./js/repairs.js?v=1.12.79','./js/invoice-edit.js?v=1.12.79','./js/app.js?v=1.12.79'
];
