const CACHE='baymeister-v1.6.3';
const PRECACHE=[
  './','./index.html','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png',
  './css/app.css?v=1.6.3','./i18n.js?v=1.6.3','./supabase-config.js',
  './js/config.js?v=1.6.3','./js/core.js?v=1.6.3','./js/cloud.js?v=1.6.3',
  './js/lookup.js?v=1.6.3','./js/app.js?v=1.6.3'
];
