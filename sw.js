const CACHE='baymeister-v1.7.1';
const PRECACHE=[
  './','./index.html','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png',
  './css/app.css?v=1.7.1','./i18n.js?v=1.7.1','./supabase-config.js',
  './js/config.js?v=1.7.1','./js/core.js?v=1.7.1','./js/cloud.js?v=1.7.1',
  './js/lookup.js?v=1.7.1','./js/app.js?v=1.7.1'
];
